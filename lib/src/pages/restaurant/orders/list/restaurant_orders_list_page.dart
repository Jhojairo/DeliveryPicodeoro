...
import 'package:pico_de_oro/src/pages/restaurant/orders/list/restaurant_orders_list_controller.dart';
import 'package:pico_de_oro/src/utils/my_theme.dart';
import 'package:pico_de_oro/src/widgets/no_data_widget.dart';

class RestaurantOrdersListPage extends StatefulWidget {
  Order order;
   RestaurantOrdersListPage({Key key, @required this.order}) : super(key: key);
