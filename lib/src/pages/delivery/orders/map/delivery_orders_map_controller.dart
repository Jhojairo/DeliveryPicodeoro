...
class DeliveryOrdersMapController {
  ...
  CameraPosition initialPosition = CameraPosition(
      target: LatLng(-1.488747,  -77.994521),
      zoom: 14
  );
  ...
  Future init(BuildContext context, Function refresh) async {
    ...
    deliveryMarker= await createMarkerFormAssets('assets/img/delivery2.png');
    homeMarker = await createMarkerFormAssets('assets/img/home.png');
...
refresh();
  ...
  Future <BitmapDescriptor> createMarkerFormAssets(String path) async{
