...
import 'package:pico_de_oro/src/pages/client/address/list/client_address_list_controller.dart';
...
///// aqu
  Widget _buttonAccept() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: _con.createOrder,// ESTE BOTON ACTIVA EL PAGO CON EL MONTO PARA LIMPIAR LA ORDEN ES AQUI
