...
import 'package:pico_de_oro/src/pages/client/orders/list/client_orders_list_controller.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.symmetric(vertical: 5),
                      child: Text(
                        'Repartidor: ${order.delivery?.name ?? ' No asigando'} ${order.delivery?.lastname ?? ''}',
                        style: TextStyle(
                            fontSize: 13
                        ),
                        maxLines: 1,
